...
(function () {
  ...
  // photographing each page into the homepage's WebGL curl, but the snapshot
  // didn't look good on content pages — the video curl stays on the homepage,
  // section turns use this clean 2D peel.)
